...
if __name__ == "__main__":
    floor_heights, floor_nodes, idealBeamsDict, idealColumnsDict, beamNamesDict, columnNamesDict = process_file("../files/5_Floors_RectangularBeams.ifc", "3dModel.scr","IdealModel.scr", export_scr=True)
